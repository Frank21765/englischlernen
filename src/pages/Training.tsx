...
export default function Training() {
  ...
  return (
    <div className="space-y-4">
      <nav className="grid grid-cols-3 gap-2 md:flex md:gap-1 md:overflow-x-auto md:pb-1 md:-mx-1 md:px-1">
        {subNav.map(({ to, label, icon: Icon, match }) => (
          <NavLink
            ...
            className={() => {
              ...
              return `flex items-center justify-center md:justify-start gap-1.5 whitespace-nowrap rounded-full px-3 py-2 md:px-3.5 md:py-1.5 text-sm font-semibold transition-smooth ${
                isActive
