...
const A1_LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t4", "Lücke füllen", "I would ___ a tea, please.", "like",
        { hint: "Verb — höfliche Bestellung", explain: "„I would like …“ ist höflicher als „I want …“." }),
      cz("t5", "Lücke füllen", "Can I have the ___, please?", "bill",
        { hint: "Substantiv — Restaurant", explain: "„the bill“ = die Rechnung." }),
      cz("t6", "Lücke füllen", "I am very ___.", "hungry", { hint: "Adjektiv — Gefühl" }),
      ...
      cz("t11", "Lücke füllen", "I don't ___ meat.", "eat", { hint: "Verb — Ernährung" }),
      cz("t12", "Lücke füllen", "This soup is ___ good.", "very", { hint: "Adverb — Verstärkung" }),
      ord("t13", "Sätze richtig anordnen", ["the", "menu", "please"], "the menu please"),
      mc("t14", "„Lecker!“ heißt …", ["Delicious!", "Heavy!", "Long!", "Hot!"], "Delicious!"),
      cz("t15", "Lücke füllen", "Two coffees ___ one tea, please.", "and", { hint: "Konnektor" }),
      mc("t16", "Welche Antwort passt zu „Anything else?“", [
        "No, thank you.", "Yes, please go.", "I am cold.", "It is morning.",
      ], "No, thank you."),
      cz("t17", "Lücke füllen", "I ___ like sugar in my coffee.", "don't", { hint: "Verneinung" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t3", "Lücke füllen", "One ticket ___ London, please.", "to",
        { hint: "Präposition — Ziel", explain: "Vor dem Reiseziel steht „to“." }),
      cz("t4", "Lücke füllen", "I am ___ Germany.", "from", { hint: "Präposition — Herkunft" }),
      cz("t5", "Lücke füllen", "Excuse me, where ___ the toilet?", "is", { hint: "Verb to be" }),
      ...
      cz("t9", "Lücke füllen", "I would like a ___ for one night.", "room", { hint: "Substantiv — Hotel" }),
      mc("t10", "„Links“ heißt …", ["left", "right", "up", "near"], "left"),
      mc("t11", "„Rechts“ heißt …", ["right", "left", "near", "far"], "right"),
      cz("t12", "Lücke füllen", "Go ___ for 100 metres.", "straight", { hint: "Adverb — Richtung" }),
      ord("t13", "Sätze richtig anordnen", ["how", "much", "is", "it"], "how much is it"),
      mc("t14", "„Flughafen“ heißt …", ["airport", "airline", "airbus", "airway"], "airport"),
      cz("t15", "Lücke füllen", "My flight is ___ 8 pm.", "at", { hint: "Präposition — Uhrzeit" }),
      ord("t16", "Sätze richtig anordnen", ["I", "need", "a", "taxi"], "I need a taxi"),
      cz("t17", "Lücke füllen", "Is there a bank ___ here?", "near", { hint: "Adverb — in der Nähe" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t3", "Lücke füllen", "I ___ two apples, please.", "want", { hint: "Verb — Wunsch" }),
      cz("t4", "Lücke füllen", "It costs five ___.", "euros", { hint: "Substantiv — Währung Plural" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "I ___ playing football.", "like", { hint: "Verb — Vorliebe" }),
      cz("t3", "Lücke füllen", "Do you ___ tennis?", "play", { hint: "Verb — Sport" }),
      ...
      cz("t7", "Lücke füllen", "I go ___ a walk on Sunday.", "for", { hint: "Feste Wendung — spazieren gehen" }),
      ...
      cz("t10", "Lücke füllen", "I play the ___.", "guitar", { hint: "Substantiv — Instrument" }),
      mc("t11", "„Park“ heißt …", ["park", "place", "yard", "field"], "park"),
      ord("t12", "Sätze richtig anordnen", ["let's", "go", "to", "the", "park"], "let's go to the park"),
      cz("t13", "Lücke füllen", "I ___ to music in the evening.", "listen", { hint: "Verb — feste Wendung mit „to“" }),
      mc("t14", "„Kino“ heißt …", ["cinema", "movie place", "film house", "show room"], "cinema"),
      cz("t15", "Lücke füllen", "On Saturday I meet ___ friends.", "my", { hint: "Possessivpronomen" }),
      ...
      cz("t18", "Lücke füllen", "I love ___ movies.", "watching", { hint: "Verb — -ing Form nach „love“" }),
    ],
  },
  {
    id: "arbeit-a1",
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "I ___ in an office.", "work", { hint: "Verb — Beruf" }),
      cz("t3", "Lücke füllen", "She is a ___.", "doctor", { hint: "Substantiv — Beruf" }),
      ...
      cz("t6", "Lücke füllen", "I start work ___ 9 am.", "at", { hint: "Präposition — Uhrzeit" }),
      cz("t7", "Lücke füllen", "I ___ home at 5.", "go", { hint: "Verb — Bewegung" }),
      ...
      cz("t11", "Lücke füllen", "I work ___ Monday to Friday.", "from", { hint: "Präposition — Zeitraum" }),
      cz("t12", "Lücke füllen", "She works ___ a hospital.", "in", { hint: "Präposition — Ort" }),
      ...
      cz("t15", "Lücke füllen", "I write ___ every day.", "emails", { hint: "Substantiv — Plural, Büro" }),
      mc("t16", "Welche Antwort passt zu „What do you do?“", [
        "I am an engineer.", "I am fine.", "It is Tuesday.", "Yes, please.",
      ], "I am an engineer."),
      cz("t17", "Lücke füllen", "My job is very ___.", "interesting", { hint: "Adjektiv — Meinung" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t3", "Lücke füllen", "It is very ___ today.", "cold", { hint: "Adjektiv — Wetter" }),
      cz("t4", "Lücke füllen", "I ___ animals.", "love", { hint: "Verb — Gefühl" }),
      ...
      cz("t8", "Lücke füllen", "Look at the ___ in the sky.", "sun", { hint: "Substantiv — Himmel" }),
      cz("t9", "Lücke füllen", "It is ___ outside.", "raining", { hint: "Verb — Wetter, -ing Form" }),
      mc("t10", "„Wald“ heißt …", ["forest", "park", "field", "garden"], "forest"),
      cz("t11", "Lücke füllen", "Birds can ___.", "fly", { hint: "Verb — Tier" }),
      ord("t12", "Sätze richtig anordnen", ["I", "see", "a", "big", "bird"], "I see a big bird"),
      mc("t13", "„Fluss“ heißt …", ["river", "lake", "sea", "rain"], "river"),
      cz("t14", "Lücke füllen", "We need clean ___.", "water", { hint: "Substantiv — Natur" }),
      mc("t15", "„Müll / Abfall“ heißt …", ["rubbish", "thing out", "old box", "drop bag"], "rubbish"),
      cz("t16", "Lücke füllen", "I love walking in the ___.", "park", { hint: "Substantiv — Ort" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t3", "Lücke füllen", "Where is the ___?", "bank", { hint: "Substantiv — Geldhaus" }),
      cz("t4", "Lücke füllen", "I have no ___.", "money", { hint: "Substantiv — Zahlungsmittel" }),
      mc("t5", "„Rechnung / Bill“ ist …", ["bill", "card", "ticket", "key"], "bill"),
      ord("t6", "Sätze richtig anordnen", ["I", "pay", "in", "cash"], "I pay in cash"),
      cz("t7", "Lücke füllen", "Can I pay ___ card?", "by", { hint: "Präposition — Zahlungsart" }),
      cz("t8", "Lücke füllen", "It is too ___ for me.", "expensive", { hint: "Adjektiv — Preis" }),
      ...
      cz("t12", "Lücke füllen", "I need to ___ money.", "change", { hint: "Verb — Geldwechsel" }),
      mc("t13", "„Geldautomat“ heißt …", ["ATM", "money box", "auto bank", "cash room"], "ATM"),
      cz("t14", "Lücke füllen", "The shop is ___.", "closed", { hint: "Adjektiv — Status" }),
      mc("t15", "„Offen“ heißt …", ["open", "closed", "ready", "in"], "open"),
      ord("t16", "Sätze richtig anordnen", ["I", "have", "ten", "euros"], "I have ten euros"),
      cz("t17", "Lücke füllen", "Can I have a ___, please?", "receipt", { hint: "Substantiv — Beleg" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "Could we have the ___, please?", "bill",
        { hint: "Substantiv — Restaurantende", explain: "„the bill“ (UK) / „the check“ (US) = die Rechnung." }),
      cz("t3", "Lücke füllen", "I'm allergic ___ nuts.", "to",
        { hint: "Präposition — Allergie", explain: "„allergic to + Substanz“." }),
      cz("t4", "Lücke füllen", "Could you ___ me a fork, please?", "bring",
        { hint: "Verb — höfliche Bitte" }),
      ...
      cz("t10", "Lücke füllen", "This soup is too ___.", "salty", { hint: "Adjektiv — Geschmack" }),
      ...
      cz("t13", "Lücke füllen", "I'd like a glass ___ red wine.", "of",
        { hint: "Präposition — Mengen", explain: "„a glass of …“ — Mengenangabe mit „of“." }),
      cz("t14", "Lücke füllen", "Is service ___ in the price?", "included",
        { hint: "Partizip — Rechnung" }),
      ...
      cz("t17", "Lücke füllen", "I'm vegetarian — I don't eat ___.", "meat", { hint: "Substantiv — Ernährung" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "My phone isn't ___.", "working",
        { hint: "Verb — Verlaufsform für Funktion", explain: "„work“ heißt hier „funktionieren“ — Verlaufsform mit -ing." }),
      cz("t3", "Lücke füllen", "I have to ___ my parents tonight.", "call",
        { hint: "Verb — Telefon" }),
      cz("t4", "Lücke füllen", "I'm running ___ of milk.", "out",
        { hint: "Phrasal verb", explain: "„run out of“ = nichts mehr haben von." }),
      ...
      cz("t8", "Lücke füllen", "I forgot ___ buy bread.", "to",
        { hint: "Infinitiv mit „to“", explain: "Nach „forget“ steht meist „to + Infinitiv“." }),
      cz("t9", "Lücke füllen", "Sorry, I'm ___ a hurry.", "in",
        { hint: "Präposition — feste Wendung", explain: "„in a hurry“ = in Eile." }),
      ...
      cz("t12", "Lücke füllen", "I need to ___ an appointment with the doctor.", "make",
        { hint: "Verb — Kollokation" }),
      cz("t13", "Lücke füllen", "Could you turn ___ the music?", "down",
        { hint: "Phrasal verb", explain: "„turn down“ = leiser machen." }),
      ...
      cz("t16", "Lücke füllen", "I'm looking ___ to the weekend.", "forward",
        { hint: "Adverb — feste Wendung", explain: "„look forward to“ = sich freuen auf." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "I'll send it ___ Friday.", "by",
        { hint: "Präposition — Frist", explain: "„by + Tag“ = bis spätestens." }),
      cz("t3", "Lücke füllen", "Can we ___ a meeting for tomorrow?", "set",
        { hint: "Verb — Kollokation", explain: "„set up a meeting“ = ein Meeting ansetzen." }),
      cz("t4", "Lücke füllen", "I'm responsible ___ the budget.", "for",
        { hint: "Präposition — Verantwortung" }),
      ...
      cz("t12", "Lücke füllen", "Please ___ me know if you have questions.", "let",
        { hint: "Verb — feste Wendung", explain: "„let someone know“ = jemanden wissen lassen." }),
      cz("t13", "Lücke füllen", "Sorry for the late ___.", "reply",
        { hint: "Substantiv — E-Mail" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "We should ___ more.", "recycle",
        { hint: "Verb — Umwelt", explain: "„recycle“ = Wiederverwerten." }),
      ...
      cz("t4", "Lücke füllen", "Please turn ___ the light when you leave.", "off",
        { hint: "Phrasal verb", explain: "„turn off“ = ausschalten." }),
      ...
      cz("t8", "Lücke füllen", "Don't ___ the water running.", "leave",
        { hint: "Verb — Umweltschutz" }),
      cz("t9", "Lücke füllen", "I usually go to work ___ bike.", "by",
        { hint: "Präposition — Verkehrsmittel" }),
      ...
      cz("t12", "Lücke füllen", "We need to ___ care of nature.", "take",
        { hint: "Verb — Kollokation", explain: "„take care of“ = sich kümmern um." }),
      cz("t13", "Lücke füllen", "It's too ___ to go out.", "cold",
        { hint: "Adjektiv — Wetter" }),
      ...
      cz("t16", "Lücke füllen", "I forgot my umbrella, and now it's ___.", "raining", { hint: "Verb — Wetter -ing" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "My card was ___.", "declined",
        { hint: "Partizip — Zahlung", explain: "„be declined“ = abgelehnt werden (Karte)." }),
      cz("t3", "Lücke füllen", "I need to ___ some money from my account.", "withdraw",
        { hint: "Verb — Bank", explain: "„withdraw money“ = Geld abheben." }),
      cz("t4", "Lücke füllen", "Could you ___ this for me, please?", "change",
        { hint: "Verb — Geldwechsel" }),
      ...
      cz("t12", "Lücke füllen", "The price ___ shipping is 50 euros.", "including",
        { hint: "Partizip — Kosten", explain: "„including + Substantiv“ = einschließlich." }),
      ...
      cz("t16", "Lücke füllen", "Prices have gone ___ a lot this year.", "up",
        { hint: "Phrasal verb", explain: "„go up“ = steigen." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "You should definitely ___ Kyoto.", "visit",
        { hint: "Verb — Reiseempfehlung" }),
      cz("t3", "Lücke füllen", "I'm thinking ___ travelling to Spain next year.", "of",
        { hint: "Präposition", explain: "„think of/about + -ing“." }),
      cz("t4", "Lücke füllen", "It's worth ___ early in the morning.", "going",
        { hint: "Verb — -ing nach „worth“", explain: "Nach „worth“ steht die -ing-Form." }),
      ...
      cz("t12", "Lücke füllen", "We got ___ the train at the wrong stop.", "off",
        { hint: "Phrasal verb", explain: "„get off“ = aussteigen (Bahn/Bus)." }),
      cz("t13", "Lücke füllen", "I can't wait ___ go on holiday.", "to",
        { hint: "Infinitiv mit „to“" }),
      ...
      cz("t16", "Lücke füllen", "I ___ never been to South America.", "have",
        { hint: "Hilfsverb — Present Perfect" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "I usually cook from ___.", "scratch",
        { hint: "Substantiv — Kochen", explain: "„from scratch“ = von Grund auf." }),
      cz("t3", "Lücke füllen", "Could you ___ down the recipe for me?", "write",
        { hint: "Verb — Phrasal verb", explain: "„write down“ = aufschreiben." }),
      ...
      cz("t8", "Lücke füllen", "Add salt ___ taste.", "to",
        { hint: "Präposition — Kochanweisung", explain: "„to taste“ = nach Geschmack." }),
      ...
      cz("t12", "Lücke füllen", "She is allergic ___ shellfish.", "to",
        { hint: "Präposition — Allergie" }),
      cz("t13", "Lücke füllen", "I could ___ a coffee right now.", "use",
        { hint: "Verb — Wunsch", explain: "„I could use …“ = ich könnte … gut gebrauchen." }),
      ...
      cz("t16", "Lücke füllen", "I'm trying to cut ___ on sugar.", "down",
        { hint: "Phrasal verb", explain: "„cut down on“ = reduzieren." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "I'd recommend that ___ — it's brilliant.", "movie",
        { hint: "Substantiv — Empfehlung" }),
      cz("t3", "Lücke füllen", "I'm really ___ forward to the concert.", "looking",
        { hint: "Verb — feste Wendung", explain: "„be looking forward to + -ing/Substantiv“." }),
      ...
      cz("t8", "Lücke füllen", "It depends ___ the weather.", "on",
        { hint: "Präposition — feste Wendung", explain: "„depend on“ = abhängen von." }),
      ...
      cz("t12", "Lücke füllen", "We had a really good ___ at the party.", "time",
        { hint: "Substantiv — feste Wendung" }),
      cz("t13", "Lücke füllen", "I'm not really ___ fan of horror movies.", "a",
        { hint: "Artikel — feste Wendung", explain: "„be a fan of …“ = Fan von … sein." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t8", "Lücke füllen", "The package never ___.", "arrived",
        { hint: "Verb — Past Simple" }),
      cz("t9", "Lücke füllen", "I'd like to exchange this ___ a smaller size.", "for",
        { hint: "Präposition — Tausch", explain: "„exchange A for B“ = A gegen B tauschen." }),
      ...
      cz("t12", "Lücke füllen", "It's still under ___, so it should be free.", "warranty",
        { hint: "Substantiv — Garantie" }),
      cz("t13", "Lücke füllen", "I can't decide ___ the two.", "between",
        { hint: "Präposition — Wahl", explain: "„between A and B“ — Wahl zwischen zweien." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "Let me ___ back to you on that.", "get",
        { hint: "Verb — Phrasal verb", explain: "„get back to someone“ = sich wieder bei jemandem melden." }),
      cz("t3", "Lücke füllen", "Could we ___ the meeting to next week?", "move",
        { hint: "Verb — Termin verschieben" }),
      cz("t4", "Lücke füllen", "I'm running a bit ___.", "late",
        { hint: "Adverb — Verspätung" }),
      ...
      cz("t8", "Lücke füllen", "I'll be there ___ ten minutes.", "in",
        { hint: "Präposition — Zeit in der Zukunft", explain: "„in + Zeitspanne“ = in (z. B. zehn) Minuten." }),
      cz("t9", "Lücke füllen", "Could you do me a ___?", "favour",
        { hint: "Substantiv — Bitte", explain: "„do someone a favour“ = jemandem einen Gefallen tun." }),
      ...
      cz("t13", "Lücke füllen", "I'm not really ___ to it today.", "up",
        { hint: "Phrasal verb", explain: "„be up to something“ = sich etwas zutrauen / Lust haben." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "Prices have gone ___ sharply this year.", "up",
        { hint: "Phrasal verb — Preise" }),
      cz("t3", "Lücke füllen", "I'd like to apply ___ a loan.", "for",
        { hint: "Präposition — Bewerbung", explain: "„apply for + Substantiv“." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "Let's ___ back to that point later.", "circle",
        { hint: "Phrasal verb — Meeting", explain: "„circle back to“ = später noch einmal aufgreifen." }),
      cz("t3", "Lücke füllen", "We need to align ___ the core priorities.", "on",
        { hint: "Präposition — Abstimmung", explain: "„align on + Thema“ = sich einig werden auf." }),
      cz("t4", "Lücke füllen", "Could you walk me ___ the proposal?", "through",
        { hint: "Phrasal verb", explain: "„walk someone through“ = jemanden durch etwas führen." }),
      ...
      cz("t8", "Lücke füllen", "We're under a tight ___.", "deadline",
        { hint: "Substantiv — Druck" }),
      cz("t9", "Lücke füllen", "I'd appreciate it ___ you could share the slides.", "if",
        { hint: "Konjunktion — höflich", explain: "„I'd appreciate it if + Past Simple“ — sehr höflich." }),
      ...
      cz("t12", "Lücke füllen", "Bear ___ mind that the budget is fixed.", "in",
        { hint: "Präposition — feste Wendung", explain: "„bear in mind“ = berücksichtigen." }),
      cz("t13", "Lücke füllen", "We're ___ the verge of closing the deal.", "on",
        { hint: "Präposition — feste Wendung", explain: "„on the verge of“ = kurz davor." }),
      ...
      cz("t16", "Lücke füllen", "Let's keep this conversation off the ___.", "record",
        { hint: "Substantiv — feste Wendung", explain: "„off the record“ = inoffiziell." }),
      ...
      cz("t18", "Lücke füllen", "We're ___ the same page now.", "on",
        { hint: "Präposition — Verständnis", explain: "„on the same page“ = einer Meinung sein." }),
    ],
  },
  {
    id: "umwelt-b2",
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "We urgently need bold policy ___.", "action",
        { hint: "Substantiv — Politik" }),
      cz("t3", "Lücke füllen", "Many countries are ___ to net-zero targets.", "committed",
        { hint: "Partizip — Verpflichtung", explain: "„be committed to + Substantiv/-ing“ = sich verpflichtet fühlen zu." }),
      cz("t4", "Lücke füllen", "There's growing concern ___ deforestation.", "about",
        { hint: "Präposition — Sorge" }),
      ...
      cz("t8", "Lücke füllen", "Renewables now ___ for over 40% of new capacity.", "account",
        { hint: "Verb — Statistik", explain: "„account for + Prozent/Anteil“ = ausmachen." }),
      ...
      cz("t12", "Lücke füllen", "The transition will be costly ___ the long run.", "in",
        { hint: "Präposition — Zeit", explain: "„in the long run“ = auf lange Sicht." }),
      cz("t13", "Lücke füllen", "Emissions have ___ to record highs.", "soared",
        { hint: "Verb — starker Anstieg", explain: "„soar“ = stark/schnell ansteigen." }),
      ...
      cz("t16", "Lücke füllen", "We can't simply ___ a blind eye to the data.", "turn",
        { hint: "Verb — feste Wendung", explain: "„turn a blind eye to“ = ignorieren." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "It was really off the beaten ___.", "track",
        { hint: "Substantiv — feste Wendung", explain: "„off the beaten track“ = abseits der Touristenpfade." }),
      cz("t3", "Lücke füllen", "We made a point ___ trying the local cuisine.", "of",
        { hint: "Präposition — feste Wendung", explain: "„make a point of + -ing“ = bewusst tun." }),
      cz("t4", "Lücke füllen", "The hotel left a lot ___ be desired.", "to",
        { hint: "Präposition — feste Wendung", explain: "„leave a lot to be desired“ = viel zu wünschen übrig lassen." }),
      ...
      cz("t8", "Lücke füllen", "We ended ___ staying an extra night.", "up",
        { hint: "Phrasal verb", explain: "„end up + -ing“ = letzten Endes etwas tun." }),
      cz("t9", "Lücke füllen", "The view was nothing ___ of spectacular.", "short",
        { hint: "Adjektiv — feste Wendung", explain: "„nothing short of“ = geradezu, geradewegs." }),
      ...
      cz("t12", "Lücke füllen", "We had to make do ___ what we had.", "with",
        { hint: "Präposition — feste Wendung", explain: "„make do with“ = sich begnügen mit." }),
      cz("t13", "Lücke füllen", "The flight wasn't ___ as bad as I'd feared.", "nearly",
        { hint: "Adverb — Vergleich", explain: "„not nearly as ... as“ = bei weitem nicht so ... wie." }),
      ...
      cz("t16", "Lücke füllen", "It pays ___ book accommodation in advance.", "to",
        { hint: "Infinitiv mit „to“", explain: "„it pays to + Infinitiv“ = es lohnt sich zu …" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "It's a bit ___-seasoned for my taste.", "under",
        { hint: "Präfix — Mangel", explain: "„under-seasoned“ = zu wenig gewürzt." }),
      cz("t3", "Lücke füllen", "The dish doesn't quite live up ___ the hype.", "to",
        { hint: "Präposition — feste Wendung", explain: "„live up to“ = gerecht werden." }),
      cz("t4", "Lücke füllen", "Could you do that ___ a vegetarian version?", "as",
        { hint: "Präposition — Variante" }),
      ...
      cz("t8", "Lücke füllen", "The wine pairs beautifully ___ the cheese.", "with",
        { hint: "Präposition — Kombination", explain: "„pair with“ = (gut) zusammenpassen mit." }),
      cz("t9", "Lücke füllen", "The chef has a real ___ for fresh herbs.", "knack",
        { hint: "Substantiv — Talent", explain: "„a knack for“ = ein Händchen für." }),
      ...
      cz("t12", "Lücke füllen", "I've developed quite a ___ for spicy food.", "taste",
        { hint: "Substantiv — feste Wendung", explain: "„develop a taste for“ = Geschmack finden an." }),
      cz("t13", "Lücke füllen", "It's not ___ my street, to be honest.", "up",
        { hint: "Phrasal verb", explain: "„not up my street“ = nicht mein Ding." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "It really ___ with me on a personal level.", "resonated",
        { hint: "Verb — Gefühl", explain: "„resonate with“ = jemanden persönlich ansprechen." }),
      cz("t3", "Lücke füllen", "The pacing felt a bit off ___ the start.", "from",
        { hint: "Präposition — Anfang" }),
      cz("t4", "Lücke füllen", "I'm not really ___ to that genre.", "drawn",
        { hint: "Partizip — Anziehung", explain: "„be drawn to“ = sich hingezogen fühlen zu." }),
      ...
      cz("t8", "Lücke füllen", "The book grew ___ me over time.", "on",
        { hint: "Phrasal verb", explain: "„grow on someone“ = einem mit der Zeit gefallen." }),
      ...
      cz("t12", "Lücke füllen", "I'm a bit ___ the fence about it.", "on",
        { hint: "Präposition — feste Wendung", explain: "„on the fence“ = unentschlossen." }),
      cz("t13", "Lücke füllen", "She has a real ___ for storytelling.", "gift",
        { hint: "Substantiv — Talent" }),
      ...
      cz("t16", "Lücke füllen", "I couldn't put it ___.", "down",
        { hint: "Phrasal verb", explain: "„can't put a book down“ = ein Buch nicht aus der Hand legen können." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "Could you ___ in a small discount?", "throw",
        { hint: "Phrasal verb — Verhandeln", explain: "„throw in“ = obendrauf geben." }),
      cz("t3", "Lücke füllen", "The brand has built up a loyal ___.", "following",
        { hint: "Substantiv — Marke", explain: "„a loyal following“ = treue Anhängerschaft." }),
      cz("t4", "Lücke füllen", "I'm willing to settle ___ a small refund.", "for",
        { hint: "Präposition — feste Wendung", explain: "„settle for“ = sich zufriedengeben mit." }),
      ...
      cz("t8", "Lücke füllen", "These products are flying ___ the shelves.", "off",
        { hint: "Phrasal verb", explain: "„fly off the shelves“ = sich blitzschnell verkaufen." }),
      cz("t9", "Lücke füllen", "I tend to shop ___ rather than online.", "in-store",
        { hint: "Adverb — Einkaufsart" }),
      ...
      cz("t12", "Lücke füllen", "We've decided to phase ___ that product line.", "out",
        { hint: "Phrasal verb", explain: "„phase out“ = auslaufen lassen." }),
      cz("t13", "Lücke füllen", "It's hardly worth ___ for the discount.", "queueing",
        { hint: "Verb — -ing nach „worth“" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t8", "Lücke füllen", "I take it back — I shouldn't have ___ that.", "said",
        { hint: "Partizip — Bedauern" }),
      cz("t9", "Lücke füllen", "He has a tendency ___ overthink things.", "to",
        { hint: "Infinitiv mit „to“", explain: "„a tendency to + Infinitiv“." }),
      ...
      cz("t12", "Lücke füllen", "Let's not jump ___ conclusions.", "to",
        { hint: "Präposition — feste Wendung", explain: "„jump to conclusions“ = voreilig schließen." }),
      cz("t13", "Lücke füllen", "I got the wrong end of the ___.", "stick",
        { hint: "Substantiv — feste Wendung", explain: "„get the wrong end of the stick“ = etwas missverstehen." }),
      ...
      cz("t16", "Lücke füllen", "She tends to be a bit set ___ her ways.", "in",
        { hint: "Präposition — feste Wendung", explain: "„set in one's ways“ = festgefahren in Gewohnheiten." }),
