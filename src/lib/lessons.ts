...
const A2_LESSONS: Lesson[] = [
  {
    ...
    tasks: [
      ...
      cz("t11", "Lücke füllen", "Breakfast is ___ from 7 to 10.", "served",
        { hint: "Hier passt eine Passiv-Form (Partizip)", explain: "Passiv mit „is + Partizip“: is served = wird serviert." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t3", "Lücke füllen", "Could you ___ down the recipe for me?", "write",
        { hint: "Hier fehlt ein Verb (Phrasal verb)", explain: "„write down“ = aufschreiben." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t2", "Lücke füllen", "Let me ___ back to you on that.", "get",
        { hint: "Hier fehlt ein Verb (Phrasal verb)", explain: "„get back to someone“ = sich wieder bei jemandem melden." }),
