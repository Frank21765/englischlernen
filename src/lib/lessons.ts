...
const B1_LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      mc("t7", "„Kein Stress“ heißt locker …", ["no worries", "no stress", "without stress", "not a stress"], "no worries",
        { explain: "Im Englischen sagt man locker „no worries“. „no stress“ versteht man zwar, ist aber keine feste Wendung." }),
