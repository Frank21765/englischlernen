...
const A1_LESSONS: Lesson[] = [
  {
    ...
    tasks: [
      ...
      cz("t12", "Lücke füllen", "I brush my ___ every morning.", "teeth",
        { hint: "Hier fehlt ein Substantiv im Plural", explain: "Plural von „tooth“ ist unregelmäßig: teeth." }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t3", "Lücke füllen", "It is very ___ today.", "cold", { hint: "Hier passt ein Wetter-Adjektiv" }),
  ...
  },
  {
    ...
    tasks: [
      ...
      cz("t13", "Lücke füllen", "It's too ___ to go out.", "cold",
        { hint: "Hier passt ein Wetter-Adjektiv" }),
